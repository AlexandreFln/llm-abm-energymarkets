...
class EnergyMarketModel(Model):
    ...
    def _create_agents(self) -> None:
        ...
        for i in range(self.num_consumers):
            ...
            self.agents['consumers'][consumer.unique_id] = consumer
        ...
        for i in range(self.num_prosumers):
            ...
            self.agents['prosumers'][prosumer.unique_id] = prosumer
        ...
        for i in range(self.num_producers):
            ...
            self.agents['producers'][producer.unique_id] = producer
        ...
        for i in range(self.num_utilities):
            ...
            self.agents['utilities'][utility.unique_id] = utility
        ...
        self.agents['regulator'] = regulator
    ...
    def get_carbon_tax_rate(self) -> float:
        ...
        if self.agents['regulator']:
            return self.agents['regulator'].current_carbon_tax
    ...
    def get_market_state(self) -> Dict[str, Any]:
        ...
        total_supply = sum(
            ...
            for producer in self.agents['producers'].values()
        )
        total_demand = sum(
            consumer.energy_needs
            for consumer in self.agents['consumers'].values()
        ) + sum(
            prosumer.energy_needs
            for prosumer in self.agents['prosumers'].values()
        )
        ...
        utility_prices = [
            ...
            for utility in self.agents['utilities'].values()
        ]
        ...
        return {
            ...
            'producers': {
                ...
                for p in self.agents['producers'].values()
            },
            'utilities': {
                u.unique_id: {
                ...
                for u in self.agents['utilities'].values()
            }
        }
